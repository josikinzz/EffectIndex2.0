...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(` - Auditory Effects `);
  _push(ssrRenderComponent(_component_Icon, {
    filename: "volume-up.svg",
    class: "categoryIcon"
  }, null, _parent));
  _push(`</h1><p><b>Auditory effects</b> are defined as any subjective effect that directly alters a person&#39;s sense of hearing. </p><p> This page lists the various auditory effects that can occur under the influence of certain psychoactive compounds. </p><hr>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/categories/index/auditory-effects.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const auditoryEffects = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { auditoryEffects as default };
//# sourceMappingURL=auditory-effects-CbwMzuVr.mjs.map
