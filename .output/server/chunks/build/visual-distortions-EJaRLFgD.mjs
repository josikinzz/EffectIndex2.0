...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(` - Visual Distortions `);
  _push(ssrRenderComponent(_component_Icon, {
    filename: "distortions.svg",
    class: "categoryIcon"
  }, null, _parent));
  _push(`</h1><p><b>Visual distortions</b> are defined as any subjective effect that alters the perception or appearance of pre-existing visual data without adding any entirely new content. </p><p> This page lists the various visual distortions that can occur under the influence of certain psychoactive compounds. </p><hr>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/categories/index/visual-distortions.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const visualDistortions = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { visualDistortions as default };
//# sourceMappingURL=visual-distortions-EJaRLFgD.mjs.map
