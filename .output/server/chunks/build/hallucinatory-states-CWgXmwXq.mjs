...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(` - Hallucinatory States `);
  _push(ssrRenderComponent(_component_Icon, {
    filename: "dragon.svg",
    class: "categoryIcon"
  }, null, _parent));
  _push(`</h1><p><b>Hallucinatory states</b> are defined as any subjective effect that changes the perception or appearance of pre-existing sensory data by adding entirely new content in a manner similar to that of dreams. </p><p> This page lists the various hallucinatory states that can occur under the influence of certain psychoactive compounds. </p><hr>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/categories/index/hallucinatory-states.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const hallucinatoryStates = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { hallucinatoryStates as default };
//# sourceMappingURL=hallucinatory-states-CWgXmwXq.mjs.map
