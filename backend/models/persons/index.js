...
router.post('/imageUpload', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-person', 'all-people'), uploadAny, async(req, res, next) => {
  try {
    const { file } = req;
    if (file) {
      try {
...
router.post('/imageCrop', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-person', 'all-people'), async(req, res, next) => {
  try {
...
router.get('/all', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), async (req, res, next) => {
  try {
...
router.get('/me', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), async(req, res, next) => {
  try {
    const { user } = req;
...
router.post('/me', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-person'), async (req, res, next) => {
  try {
    const { user } = req;
...
router.post('/', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256']}), hasPerms('all-people'), async (req, res, next) => {
  try {
...
router.put('/meta/:_id', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('all-people'), async (req, res, next) => {
...
router.put('/:_id', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256']}), hasPerms('all-people'), async (req, res, next) => {
  const { user } = req;
...
router.delete('/:_id', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('all-people'), async (req, res, next) => {
  const { _id } = req.params;
  try {
