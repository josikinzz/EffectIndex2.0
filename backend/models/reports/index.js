...
router.post('/', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-reports', 'all-reports'), async (req, res, next) => {
...
router.put('/:id', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-reports', 'all-reports'), async (req, res, next) => {
...
router.delete('/:id', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-reports', 'all-reports'), async (req, res, next) => {
  const { user } = req;
...
router.get('/admin', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-reports', 'all-reports'), async (req, res, next) => {
  const { user } = req;
  try {
...
router.get('/:id', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256'] }), hasPerms('own-reports', 'all-reports'), async(req, res, next) => {
  try {
    const { user } = req;
