...
router.post('/', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256']}), hasRoles(['admin', 'editor']), async (req, res) => {
...
router.post('/:id', secured({ requestProperty: 'user', secret: config.jwtSecret, algorithms: ['HS256']}), hasRoles(['admin', 'editor']), async (req, res) => {
  try {
